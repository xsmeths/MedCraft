...
public class MedkitEvents extends CustomItemUtil.ItemEvents {
    ...
    public void onInteract(PlayerInteractEvent e){
        ...
        if (i.getItemMeta() != null)
            if (e.getAction() != Action.PHYSICAL && !p.hasPotionEffect(PotionEffectType.REGENERATION)
                    ...
                    && (i.getType().equals(me.smeths.and.rhetorical.itemmanager.ItemLoader.getMedKitItem().getType())) && i.getItemMeta().hasCustomModelData()
